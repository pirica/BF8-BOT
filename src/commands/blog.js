...
module.exports = {
    ...
    async execute(message, args) {
        axios({
            ...
            let text = "";
            //if(response.data.blogList[0].shareDescription != undefined) text += `${response.data.blogList[0].shareDescription}\n\n`;
            text += `[Lien de l'article](https://www.epicgames.com/fortnite${response.data.blogList[0].urlPattern})\nArticle 1/5`;
            ...
            collector.on('collect', async m => {
                ...
                text = "";
                //if(response.data.blogList[num[m.emoji.name]].shareDescription != undefined) text += `${response.data.blogList[num[m.emoji.name]].shareDescription}\n\n`;
                text += `[Lien de l'article](https://www.epicgames.com/fortnite${response.data.blogList[num[m.emoji.name]].urlPattern})\nArticle ${num[m.emoji.name]+1}/5`;
