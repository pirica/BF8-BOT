...
module.exports = {
    ...
    async generateShop(data) {
        return new Promise(async(resolve, reject) => {
            ...
            ctx.textAlign = "left";
            const boutique = ctx.measureText("BF8-BOT").width
            ...
            ctx.font = "italic 73px Burbank Big Rg Bd";
            ctx.fillText("BF8-BOT", left, 148);
            ctx.font = "italic 76px Burbank Big Rg Bd";
            ctx.fillStyle = '#ffffff';
            ctx.fillText("twiter:Arab leakers", left+boutique+34, 139);
